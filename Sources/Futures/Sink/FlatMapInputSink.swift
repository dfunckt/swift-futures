...
extension Sink._Private {
    public struct FlatMapInput<Input, U: StreamConvertible, Base: SinkProtocol> where Base.Input == U.StreamType.Output {
...
extension Sink._Private.FlatMapInput: SinkProtocol {
