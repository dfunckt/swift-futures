...
extension Stream._Private {
    public enum Join<A: StreamProtocol, B: StreamProtocol> {
        case pending(A, B)
...
extension Stream._Private.Join: StreamProtocol {
...
extension Stream._Private {
    public enum Join3<A: StreamProtocol, B: StreamProtocol, C: StreamProtocol> {
...
extension Stream._Private.Join3: StreamProtocol {
...
extension Stream._Private {
    public enum Join4<A: StreamProtocol, B: StreamProtocol, C: StreamProtocol, D: StreamProtocol> {
...
extension Stream._Private.Join4: StreamProtocol {
