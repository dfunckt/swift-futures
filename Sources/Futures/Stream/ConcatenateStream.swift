...
extension Stream._Private {
    public enum Concatenate<Prefix: StreamProtocol, Suffix: StreamProtocol> where Suffix.Output == Prefix.Output {
...
extension Stream._Private.Concatenate: StreamProtocol {
